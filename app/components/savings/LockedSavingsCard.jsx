...
function LockedSavingsCard({
	...
	return (
		<div
			onClick={selectPlan}
			className="hover:ring-2 hover:ring-[--lines] hover:ring-offset-2 transitioning rounded-[10px] lg:rounded-[16px] group self-stretch cursor-pointer"
		>
			<div className="grid grid-cols-5 rounded-[10px] h-full lg:rounded-[16px] border border-[--lines] p-1 lg:p-0">
				<div className="col-span-2 relative overflow-hidden rounded-[10px] lg:rounded-l-[16px] lg:rounded-r-none">
					<Image
						className="absolute w-full h-full object-cover rounded-[10px] lg:rounded-l-[16px] lg:rounded-r-none group-hover:scale-110 transform transition-all duration-1000 ease-in-out"
						fill
				...
				<div className="self-stretch rounded-r-[16px] col-span-3 py-1 lg:pt-3 lg:pb-4 px-2 md:px-4 space-y-4 truncate">
					<div className="truncate">
						<h1 className="text-left font-semibold capitalize xl:text-lg truncate ">
							{lockName}
						</h1>
						{paymentMode === "auto" && (
					...
					<div className=" flex flex-row justify-between items-center">
						<div className="flex flex-col justify-center items-start">
							...
							<span className="text-left  capitalize text-[0.8rem] leading-[0.88rem] md:text-sm">
								{" "}
								Amount Saved{" "}
							</span>
						</div>
						...
						<div className="flex flex-col justify-center items-end md:items-start">
							<span className="text-[--highlight] text-right font-medium text-sm">
								{lockDurationInMonths > 1
									? `${lockDurationInMonths} months`
									: `${lockDurationInMonths} month`}
							</span>
							<span className="text-right capitalize text-[0.8rem] leading-[0.88rem] md:text-sm  ">
								<span className="hidden xl:inline">Investment</span> Duration
							</span>
						</div>
					</div>
					...
					<div className="flex items-center space-x-7 lg:space-x-10">
						...
						<div className="pb-1">
							<span className="md:font-medium text-left  capitalize text-sm  ">
								{percentageSaved}%
							</span>
						</div>
					</div>
