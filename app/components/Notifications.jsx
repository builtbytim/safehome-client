						...
						{data && data.unfilteredEntries === 0 && (
							<div className="w-full flex h-full flex-col justify-center items-center space-y-4">
								...
								<button
									...
									onClick={refetch}
									className={
										"text-[--text] self-center text-xs  py-1 px-2 transitioning border border-[--lines] rounded-brand hover:cursor-pointer hover:bg-[--b1] flex flex-row justify-center items-center space-x-1 disabled:opacity-40 " +
										cn({
