		...
		<header className="w-full  ">
			<div className="w-full flex flex-row justify-between items-center ">
				<div className="flex flex-row justify-start ">
					<BiMenuAltLeft className="text-[--highlight] self-center text-4xl md:hidden " />
					<h1 className="self-center text-[--highlight] capitalize text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-bold">
						{" "}
						Investment{" "}
					</h1>
				</div>
