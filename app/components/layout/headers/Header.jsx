      ...
      <div className="w-full flex flex-row justify-between items-center ">
        <div className="flex flex-row justify-center items-center  space-x-4 md:space-x-8">
          ...
          <div className="self-center ">
            <h1 className="self-center text-[--text] capitalize text-xl sm:text-2xl md:text-3xl lg:text-4xl  font-semibold ">
              <span className="font-normal">Hello</span> {user.firstName}
              {"!"}
            </h1>

            <span className="text-sm text-[--text]"> Take the bold step </span>
          </div>
        </div>
          ...
          <div className="self-center p-1 hidden md:block ">
            {showSidebar ? (
              <BiX
                ...
                className="text-[--text]   text-4xl md:hidden "
              />
            ) : (
              <BiMenuAltLeft
                onClick={toggleSidebar}
