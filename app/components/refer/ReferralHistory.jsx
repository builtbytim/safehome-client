	...
	return (
		<div>
			<div className="flex flex-col md:flex-row justify-between gap-5 items-center pt-8">
				<p className="text-[--header] px-1 self-start md:self-center font-semibold text-lg ">
					Referral History
				</p>
				...
				data.numItems > 0 && (
					<div>
						<div className="py-8 overflow-auto max-h-[482px]">
							<table className="w-full table text-[--text] font-normal ">
			...
			<div>
				<div className="grid grid-cols-1 md:grid-cols-2 gap-7 border-b border-[--text-brand] py-3 font-semibold text-[--header]">
