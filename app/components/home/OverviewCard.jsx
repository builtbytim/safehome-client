          ...
          ></ScrollLink> */}
				...
				>
					...
					>
						...
						<h2 className=" text-[--text] font-medium"> My Funds </h2>

						<div className="flex flex-row items-center justify-start space-x-2">
							<p className="text-[--text] self-center font-bold text-xl lg:text-2xl">
								<NumericFormat
							...
							{isError && (
								<button
									...
									disabled={isLoading}
									className={
										"text-[--text] self-center text-xs  py-1 px-2 transitioning border border-[--lines] rounded-brand hover:cursor-pointer hover:bg-[--lines] flex flex-row justify-center items-center " +
										cn({
					...
					<div
						id="total-savings"
						className="bg-[#ff6100]/10 w-full min-w-[100%] sm:min-w-[60%] lg:min-w-[344px] rounded-brand p-6  flex-col justify-center items-start space-y-6 hidden"
					>
						<div>
							<Image src={Savingsmage} alt="my funds" width="48" />
						</div>

						<h2 className=" text-[--text] font-medium"> Total Savings </h2>
					...
					>
						...
						<h2 className=" text-[--text] font-medium"> Total Investments</h2>
