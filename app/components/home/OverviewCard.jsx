  ...
  return (
    <section className="bg-white rounded-brand  md:p-8 space-y-4 lg:space-y-8">
      ...
      <div className=" flex flex-row  md:hidden justify-between items-center space-x-4">
        <button className="btn-2 py-3 flex justify-center whitespace-nowrap text-sm lg:text-base space-x-2 items-center">
          <AiOutlineMinus className="" />
          <span>Withdraw</span>
        </button>

        <button className="btn-1 py-3 flex justify-center text-sm lg:text-base whitespace-nowrap space-x-2 items-center">
          <AiOutlinePlus className="" />
          <span>Add Fund</span>
        </button>
      </div>
