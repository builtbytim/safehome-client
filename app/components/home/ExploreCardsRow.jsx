...
const exploreItems = [
	{
		...
		body:
			"Hello, Kindly finish your KYC so we can verify your identity and comply with regulatory requirements.",
		img: explore1,
		link: "/kyc",
	},

	{
		...
		body:
			"Explore our diverse Real Estate portfolio and get a feel of our asset options and performance history",
		img: explore2,
...
function ExploreCardsRow({ user }) {
	return (
		<>
			<h2 className="text-xl  pt-6 md lg:text-2xl xl:text-3xl text-left text-[--text] font-medium ">
				Explore
			</h2>
			<div
