			...
			<main className=" space-y-2 lg:space-y-10">
				...
				<section className="bg-white rounded-brand  pt-7 md:p-8 space-y-4">
					<div className="w-full flex flex-col xl:flex-row justify-between xl:items-center xl:gap-16 xl:pb-1">
						...
						<div className="flex flex-wrap xl:justify-end items-center gap-3 lg:gap-5 w-full max-w-full text-sm lg:text-base">
							<div>
							...
							<button
								...
								className="bg-white border border-[--lines] rounded-lg lg:rounded-[1.1rem] flex gap-1 lg:gap-3 px-2 lg:px-6 items-center py-2"
							>
								Clear All
							</button>
						</div>
